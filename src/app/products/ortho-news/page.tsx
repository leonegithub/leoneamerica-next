...
const Downloads = () => {
  ...
  const url =
    "https://php.leone.it/api/GetDownload.php?tipologia=bollettino&sezione=ortodonzia&progetto=leoneamerica&lingua=EN";
  const fetchOptions = {
    headers: {
      Authorization:
  ...
  // ordina i risultati in ordine alfabetico discendente
  result.sort((a, b) => {
    if (a.nome < b.nome) {
      return 1;
    }
  ...
  return (
    <div className="downloads">
      <div className="container">
        ...
        <div className="list gap-5 my-3 grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
          {isLoading ? (
            <div role="status">
              <svg
                aria-hidden="true"
